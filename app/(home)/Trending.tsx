...
const Trending = (props: Props) => {
    return (
        <section className='pt-3 pb-10'>
            ...
            {/* Trending Grid */}
            {/* Using 4 columns  and 2 rows & h-[600px] is how you specify a certain height instead of h-48 or h-96 etc */}
            ...
            <p className="text-sm">
                Consectetur fugiat laboriosam, atque deserunt fuga reiciendis architecto, illum distinctio dolorem quaerat ab nisi quo iste omnis ullam ipsam, numquam nihil? Quam.
            </p>
        </section>
    )
}
